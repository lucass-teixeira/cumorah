...
export class StudentService {
  ...
  public mentors: Mentor[] = [
    ...
    { id: 9, name: 'Adam & Chealse', imgURL: 'https://user-images.githubusercontent.com/54940494/253288957-652b7d3d-ac3a-421b-9d33-4d03d74d6bb4.jpg', type: CategoryEnum.mentors, topics: ['In 1986 Ralph Little was named to the INC 500 list as one of “Fastest Growing Private Companies in America”', 'In the twenty years he owned Little & Company, Ralph started several other businesses including a software development company, a truck tire recapping plant, storage units, a marketing company, and an electrical wiring and device company.', 'He was referred to a course of instruction at Harvard specifically for CEOs of small businesses.'] },
  ]

  public courses: Course[] = [
    { id: 1, name: 'Leadership', imgURL: 'https://my.cumorahacademy.org/_files/categories/42_6Yzw2TUM.jpg?fit=770x200', type: CategoryEnum.education, classes: [{ title: 'Givers vs Takers', isDone: true }] },
  ...
  public items: Student[] = [
    ...
    { id: 5, englishLevel: EnglishLevel.b2, type: CategoryEnum.students, name: 'Vladyslava', nickname: 'Vlada', points: 4, birthdate: new Date('2002-03-04'), age: 21, imgURL: 'https://user-images.githubusercontent.com/54940494/238946446-aaf3162d-2db1-45cc-bd11-5b86abbc5e12.jpg', idGroup: Group.Esther, countryCode: Country.ucrania },
    ...
    { id: 14, englishLevel: EnglishLevel.b2, type: CategoryEnum.students, name: 'Yetsy', nickname: 'Yetsy', points: 4, birthdate: new Date('2002-03-04'), age: 21, imgURL: 'https://user-images.githubusercontent.com/54940494/238946457-86e7ad68-7a7f-48b6-96fe-afdba17f26cf.jpg', idGroup: Group.Esther, countryCode: Country.brazil },
