...
export class StudentService {
  ...
  public items: Student[] = [
    ...
    { id: 4, englishLevel: EnglishLevel.b2, type: CategoryEnum.students, name: 'Emy', nickname: 'Emy', points: 3, birthdate: new Date('2002-03-04'), age: 21, imgURL: 'https://user-images.githubusercontent.com/54940494/261656510-7a06f30f-e677-4e65-ac18-581c001c6285.jpg', idGroup: Group.Esther, countryCode: Country.peru, hobbies: ['dance', 'read', 'watch movies'], mainCourse: MainCourse.english },
    { id: 5, englishLevel: EnglishLevel.b2, type: CategoryEnum.students, name: 'Vladyslava', nickname: 'Vlada', points: 4, birthdate: new Date('2002-03-04'), age: 21, imgURL: 'https://user-images.githubusercontent.com/54940494/261656517-049ea9e3-de6d-48ff-9724-87f0eb6af1c9.jpg', idGroup: Group.Esther, countryCode: Country.ucrania },
    { id: 6, englishLevel: EnglishLevel.b2, type: CategoryEnum.students, name: 'Gabriel', nickname: 'Gabe', points: 0, birthdate: new Date('2002-03-04'), age: 21, imgURL: 'https://user-images.githubusercontent.com/54940494/261658303-733e7929-d9b0-47a0-86da-33fcf7ab7721.jpg', idGroup: Group.Esther, countryCode: Country.brazil, hobbies: ['poem', 'skating', 'nature'], linkedin: 'https://www.linkedin.com/in/gabriel-oliveira-a84910223/', imgs: [{ url: 'https://user-images.githubusercontent.com/54940494/248789765-492e16c1-3a8b-446d-9079-93e8042b69e6.jpg' }, { url: 'https://user-images.githubusercontent.com/54940494/248789628-db908c76-d8fc-4b40-9156-097362cafe8a.jpg' }] },
    ...
    { id: 12, englishLevel: EnglishLevel.b2, type: CategoryEnum.students, name: 'Pamela', nickname: 'Pam', points: 4, birthdate: new Date('2002-03-04'), age: 21, imgURL: 'https://user-images.githubusercontent.com/54940494/261656508-58645b18-848b-45c0-a019-ca2f95364123.jpg', idGroup: Group.Esther, countryCode: Country.brazil, linkedin: 'https://www.linkedin.com/in/pamela-gomes-dev/', mainCourse: MainCourse.business },
    ...
    { id: 14, englishLevel: EnglishLevel.b2, type: CategoryEnum.students, name: 'Yetsy', nickname: 'Yetsy', points: 4, birthdate: new Date('2002-03-04'), age: 21, imgURL: 'https://user-images.githubusercontent.com/54940494/261656513-36b4d8ca-d89d-4c53-a611-abe86496d86d.jpg', idGroup: Group.Esther, countryCode: Country.brazil },
    ...
    { id: 16, englishLevel: EnglishLevel.b2, type: CategoryEnum.students, name: 'Leticia', nickname: 'Leticia', points: 5, birthdate: new Date('2002-03-04'), age: 21, imgURL: 'https://user-images.githubusercontent.com/54940494/261656479-6b048f7d-b4f0-4e70-bad0-64b5a368f03b.jpg', idGroup: Group.Esther, countryCode: Country.brazil, hobbies: ['dancing', 'running'], mainCourse: MainCourse.business },
